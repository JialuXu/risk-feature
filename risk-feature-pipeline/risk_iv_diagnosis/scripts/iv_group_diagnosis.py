# -*- coding: utf-8 -*-
"""兼容 shim：分析引擎已收敛到 `risk_mining.analysis.engine`。
...
新代码请直接：
    from risk_mining.analysis.engine import univariate_by_group, iv_by_group, lr_by_group, ...
"""
from risk_mining.analysis.engine import *  # noqa: F401,F403
