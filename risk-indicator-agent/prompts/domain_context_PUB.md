...
PUB 域来自外部舆情爬取 (新闻/裁判文书/经营异常公示等). 通常信号偏弱但稳定. 信号弱不代表无价值 — 是规则系统的"触发器"而非主评分入参.

## 主要基础表

- `DEMO_CORP_PUBLIC_OPINION` —— **底表已就绪,无缺口**
   - `CUST_NO` 客户编号
...
- 大部分舆情指标信号偏弱 → priority 多为 P3-观察 / P2
- 但少数标签 IV 较强 (如"信贷逾期") → 可入 P1
